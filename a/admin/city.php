...
if (isset($_POST['submit'])) {
    ...
    // get fields
    $province_id = $action->request('province_id');
    ...
    // send query
    if ($edit) {
        $command = $action->city_edit($id,$province_id,$name, $status);
    } else {
        $command = $action->city_add($province_id,$name, $status);
    }
    ...
    <div class="row page-titles">
        ...
        <div class="col-md-12 align-self-center text-right">
            <?php if (!isset($_GET['action'])) { ?>
                <h3 class="text-primary">ثبت شهرستان</h3>
            <?php } else { ?>
                <h3 class="text-primary">ویرایش شهرستان</h3>
            <?php } ?>
        </div>
        <!-- ----------- end title ----------------------------------------------------------------------------- -->
        ...
        <div class="col-md-12 align-self-center text-right">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?= $list_url ?>">شهرستان ها</a></li>
                <?php if ($edit) { ?>
