...
if (isset($_POST['submit'])) {
    ...
    if($_FILES["icon"]["name"]){
        unlink("../admin/images/shops/$icon");
    ...
    <div class="row page-titles">
        ...
        <div class="col-md-12 align-self-center text-right">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">تنظیمات فروشگاه</li>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
                    ...
                    <div class="card-body">
                        <div class="basic-form">
                            ...
                            <div class="form-group">
                                ...
                                <?if($edit){?>
                                <div class="input_fields_wrap form-group shop-gallery" >
                                    <h5 class="title_add">عکس های گالری فروشگاه را انتخاب نمایید</h5>
            ...
            <? if($edit && $row->image) { ?>
                    <div class="col-lg-6">
                        <div class="card">
                            <img src="../admin/images/shops/<?= $row->image ?>">
                        </div>
                        <?
                            ...
                            while ($picture = $pictures->fetch_object()) {
                                ...
                                <div class="card" style="margin:10px">
                                    <img src="../admin/images/shops/<?= $picture->image ?>">
                                </div>
                                </div>
...
$(document).ready(function() {
	...
	$(add_button).click(function(e){ //on add input button click
		...
		if(x < max_fields){ //max input box allowed
			...
			$(wrapper).append('<div class="add-pic-shop" style="margin-bottom: 10px;"><label class="btn btn-dark btn-block m-0 add-pic-btn">انتخاب عکس<input type="file" name="upload[]" style="visibility:hidden;"></label><a href="#" class="remove_field"><i class="fas fa-times"></i></a></div>'); //add input box
		}
	});
