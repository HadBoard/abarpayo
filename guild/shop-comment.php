...
if (isset($_POST['submit'])) {
    ...
    if ($edit) {
        if(!empty($text)){
            $res = $action->shop_comment_list();
            $user_id=$action->user_get($res->fetch_object()->user_id)->id;
            $command = $action->shop_comment_add($user_id,$id,$text);
        }
        if($confirm){
                    ...
                    <div class="card-body">
                        <div class="basic-form">
                            <form action="" method="post">
                                ...
                                <div class="form-group">
                                    <textarea type="text" name="text" class="form-control input-default " placeholder="متن پاسخ"><?= ($reply) ? $reply->text : "" ?></textarea>
                                </div>
