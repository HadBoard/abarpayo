...
if(isset($_GET['solved'])){
    $result = $action->solved_shop_ticket_list();
    $solved = 1;
}
else if(isset($_GET['not-solved'])){
    $result = $action->not_solved_shop_ticket_list();
    $not_solved = 1;

}
else if(isset($_GET['in-queue'])){
    $result = $action->in_queue_shop_ticket_list();
    $in_queue = 1;
}
else if(isset($_GET['solving'])){
    $result = $action->solving_shop_ticket_list();
    $solving = 1;
}else{
...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        ...
        <div class="col-md-12 align-self-center text-right">
            <h3 class="text-primary"> تیکت اصناف</h3></div>
        <div class="col-md-12 align-self-center text-right">
            <ol class="breadcrumb">
