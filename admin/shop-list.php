...
if (isset($_GET['status'])) {
    ...
    $_SESSION['error'] = !$action->shop_status($id);
    header("Location: $list_url");
    return;
}
// ----------- change status -------------------------------------------------------------------------------------------
    ...
    <div class="page-wrapper">
        ...
        <div class="row page-titles">
            ...
            <div class="col-md-12 align-self-center text-right">
                <h3 class="text-primary">فروشگاه ها</h3></div>
            <div class="col-md-12 align-self-center text-right">
                <ol class="breadcrumb">
        ...
        <div class="container-fluid">
            ...
            <!-- ----------- add button ---------------------------------------------------------------------------- -->
            <div class="row">
                <a class="add-user mb-2" href="<?= $main_url ?>"> ثبت فروشگاه <i class="fas fa-plus"></i></a>
            </div>
            <!-- ----------- add button ---------------------------------------------------------------------------- -->
                                ...
                                <table id="example23" class="display nowrap table table-hover table-striped"
                                    ...
                                    <? while ($row = $result->fetch_object()) { ?>
                                        <tr class="text-center">
                                            ...
                                            <a href="shop-cart.php?shop=<?= $row->id ?>">
