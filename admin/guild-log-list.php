...
if (isset($_GET['remove'])) {
    ...
    $_SESSION['error'] = !$action->change_admin_view($id,3);
    ...
    <div class="page-wrapper">
        ...
        <div class="row page-titles">
            ...
            <div class="col-md-12 align-self-center text-right">
                <h3 class="text-primary">لاگ اصناف</h3></div>
            <div class="col-md-12 align-self-center text-right">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="javascript:void(0)">لاگ اصناف</a></li>
                </ol>
            </div>
            <!-- ----------- end breadcrumb ------------------------------------------------------------------------ -->
                                ...
                                <table id="example23" class="display nowrap table table-hover table-striped"
                                    ...
                                    while ($row = $result->fetch_object()) { ?>
                                        <tr class="text-center">
                                            ...
                                            <td class="text-center"><?= $action->shop_admin_get($row->guild_id)->first_name." ".$action->shop_admin_get($row->guild_id)->last_name; ?></td>
