...
// ----------- get data ------------------------------------------------------------------------------------------------
$counter = 1;
$result = $action->shop_request_list();
// ----------- get data ------------------------------------------------------------------------------------------------

// ----------- delete --------------------------------------------------------------------------------------------------
if (isset($_GET['remove'])) {
    $id = $action->request('remove');
    $_SESSION['error'] = !$action->shop_request_remove($id);
...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        ...
        <div class="col-md-12 align-self-center text-right">
            <h3 class="text-primary">درخواست های اصناف</h3></div>
        <div class="col-md-12 align-self-center text-right">
            <ol class="breadcrumb">
                        ...
                        <div class="table-responsive m-t-5">
                            <table id="example23" class="display nowrap table table-hover table-striped"
                                ...
                                <tr>
                                    ...
                                    <th class="text-center">صاحب صنف</th>
                                ...
                                <? while ($row = $result->fetch_object()) { ?>
                                    <tr class="text-center">
                                        ...
                                        <td class="text-center">
                                            <a href="shop-request.php?edit=<?= $row->id ?>">
