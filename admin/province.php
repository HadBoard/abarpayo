...
if (isset($_POST['submit'])) {
    ...
    // send query
    if ($edit) {
        $command = $action->province_edit($id, $name, $status);
    } else {
        $command = $action->province_add($name, $status);
    }
    ...
    <div class="row page-titles">
        ...
        <div class="col-md-12 align-self-center text-right">
            <?php if (!isset($_GET['action'])) { ?>
                <h3 class="text-primary">ثبت استان</h3>
            <?php } else { ?>
                <h3 class="text-primary">ویرایش استان</h3>
            <?php } ?>
        </div>
        <!-- ----------- end title ----------------------------------------------------------------------------- -->
        ...
        <div class="col-md-12 align-self-center text-right">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?= $list_url ?>">استان ها</a></li>
                <?php if ($edit) { ?>
